...
namespace PusherClient
{
    internal class Connection
    {
        ...
        {
            /* Commented out as we no longer set this during websocket_Error, so this isn't needed
        ...
        private void websocket_Error(object sender, SuperSocket.ClientEngine.ErrorEventArgs e)
        {
            ...
            /*  Don't execute TrySetException as this throws an uncaught exception which causes the service to crash
             *  During testing, the websocket_Closed callback is also fired, which results in an automatic reconnection
            if (_connectionTaskComplete != null)
            {                
